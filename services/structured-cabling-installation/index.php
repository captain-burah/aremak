...
<head>
    ...
    <!--TITLE & DESCRIPTIONS-->
    <title>Structured Cabling Installation Dubai | High-Speed Network Setup</title>
    <meta name="description"
        content="Optimize your network with expert structured cabling installation in Dubai. Scalable, efficient solutions for business and industrial use.">
        ...
        <section class="bg-image d-flex align-items-center"
            ...
            <div class="mask w-100 h-100 d-flex align-items-center" style="background-color: rgba(0, 0, 0, 0.5);">
                <div class="container text-white text-center">
                    <h1 class="">Structured Cabling Installation</h1>
                </div>
            </div>
        </section>
        <!-- HEADER -->
