...
<head>
  ...
  <!--TITLE & DESCRIPTIONS-->
  <title>CCTV Camera Installation & Maintenance in Dubai | SIRA-Compliant</title>
  <meta name="description"
    content="Secure your property with expert CCTV camera installation and maintenance in Dubai. High-definition, remote access, and SIRA-approved solutions.">
  ...
  <!--CANONICAL LINKS-->
  <link rel="canonical" href="https://www.aremak.com/services/cctv-camera-installation-and-maintenance">
...
<?php
  ...
  <main>
    ...
    <section class="bg-image d-flex align-items-center"
      style="background-image: url('../images/services/cctv.webp'); height: 50vh; background-size: cover; background-position: center;">
      <div class="mask w-100 h-100 d-flex align-items-center" style="background-color: rgba(0, 0, 0, 0.5);">
        <div class="container text-white text-center">
          <h1 class="">CCTV Camera Installation & Maintenance</h1>
        </div>
      </div>
    </section>
    <!-- HEADER -->
    ...
    <section class="text-left bg-white py-4">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <form class="border border-primary rounded px-3 py-3">
              ...
              <button type="submit" class="btn btn-primary">Register Your Interest</button>
            </form>
          </div>
        </div>
      </div>
