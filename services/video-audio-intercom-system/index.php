...
<head>
    ...
    <!--TITLE & DESCRIPTIONS-->
    <title>Video & Audio Intercom Systems Dubai | Secure Visitor Communication</title>
    <meta name="description"
        content="Install advanced intercom systems with video and audio for secure communication and door access in homes and buildings across Dubai.">
...
<body>
    ...
    <main>
        ...
        <section class="bg-image d-flex align-items-center"
            style="background-image: url('../images/services/intercom.webp'); height: 50vh; background-size: cover; background-position: center;">
            <div class="mask w-100 h-100 d-flex align-items-center" style="background-color: rgba(0, 0, 0, 0.5);">
                <div class="container text-white text-center">
                    <h1 class="">Video & Audio Intercom Systems</h1>
                </div>
            </div>
        </section>
        <!-- HEADER -->
