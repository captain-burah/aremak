...
<head>
  ...
  <!--TITLE & DESCRIPTIONS-->
  <title>Access Control System Installation Dubai | Smart Entry Solutions</title>
  <meta name="description"
    content="Enhance security with advanced access control systems including biometrics and RFID. Professional installation services across Dubai.">
  ...
  <!--CANONICAL LINKS-->
  <link rel="canonical" href="https://www.aremak.com/services/access-control-system-installation">
...
<?php
  ...
  <main>
    ...
    <section class="bg-image d-flex align-items-center"
      style="background-image: url('../images/services/access-control.webp'); height: 50vh; background-size: cover; background-position: center;">
      <div class="mask w-100 h-100 d-flex align-items-center" style="background-color: rgba(0, 0, 0, 0.5);">
        <div class="container text-white text-center">
          <h1 class="">Access Control Systems</h1>
        </div>
      </div>
    </section>
    <!-- HEADER -->
