...
<head>
    ...
    <!--TITLE & DESCRIPTIONS-->
    <title>SMATV System Installation Dubai | Centralized TV Distribution</title>
    <meta name="description"
        content="Centralize television content with reliable SMATV system installation for hotels, buildings, and commercial properties in Dubai.">
...
<?php
    ...
    <section class="bg-image d-flex align-items-center"
        style="background-image: url('../images/services/smatv.webp'); height: 50vh; background-size: cover; background-position: center;">
        <div class="mask w-100 h-100 d-flex align-items-center" style="background-color: rgba(0, 0, 0, 0.5);">
            <div class="container text-white text-center">
                <h1 class="">SMATV System Installation</h1>
            </div>
        </div>
    </section>
    <!-- HEADER -->
