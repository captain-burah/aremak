...
<head>
    ...
    <!--TITLE & DESCRIPTIONS-->
    <title>Smart Door Lock Systems Dubai | Digital Security Solutions</title>
    <meta name="description"
        content="Upgrade to smart door lock systems with mobile access, biometrics & PIN code entry. Ideal for homes and offices across Dubai.">
        ...
        <section class="bg-image d-flex align-items-center"
            ...
            <div class="mask w-100 h-100 d-flex align-items-center" style="background-color: rgba(0, 0, 0, 0.5);">
                <div class="container text-white text-center">
                    <h1 class="">Smart Door Lock Systems</h1>
                </div>
            </div>
        </section>
        <!-- HEADER -->
