...
<head>
    ...
    <!--TITLE & DESCRIPTIONS-->
    <title>Automatic Gate Barrier Solutions Dubai | Vehicle Access Control</title>
    <meta name="description"
        content="Control vehicle access efficiently with automatic gate barrier systems in Dubai. RFID, ANPR & remote integration available.">
    ...
    <!--CANONICAL LINKS-->
    <link rel="canonical" href="https://www.aremak.com/services/automatic-gate-barrier-solutions">
...
<?php
    ...
    <main>
        ...
        <section class="bg-image d-flex align-items-center"
            style="background-image: url('../images/services/gate-barrier.webp'); height: 50vh; background-size: cover; background-position: center;">
            <div class="mask w-100 h-100 d-flex align-items-center" style="background-color: rgba(0, 0, 0, 0.5);">
                <div class="container text-white text-center">
                    <h1 class="">Automatic Gate Barrier Solutions</h1>
                </div>
            </div>
        </section>
        <!-- HEADER -->
